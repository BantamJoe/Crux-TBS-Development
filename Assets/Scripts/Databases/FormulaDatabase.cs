...
public class FormulaDatabase : MonoBehaviour {

	//The formulas used for determining Maximum Health, Stamina, and Mana. 
	public string maxHealthFormula = "caster.control + ( caster.focus / 2 ) + ( caster.fortune / 2)";
	public string maxManaFormula = "caster.tethering + ( caster.intelligence / 2 ) + ( caster.personality / 4)";
	public string maxStaminaFormula = "100 + ( caster.agility / 4 ) + ( caster.power / 6 ) + ( caster.focus / 6 ) + ( caster.control / 6 )";
	public string perTurnManaRegenFormula = "caster.tethering / 5 + caster.intelligence / 6 + caster.personality / 6";


	public string maxJumpFormula = "2";
	public string moveSpeedFormula = ".5";
	...
	public FormulaDatabase(char decimalSeparator)
	{
	...
	public int damageParse(BattleActor caster, BattleActor target, string formula)
	{
